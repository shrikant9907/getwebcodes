...
<head>
  ...
  <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/components.css" />
  <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/utils.css" />
        ...
        <div class="col-12 col-md-3"> 
          <div class="site_logo with_image">
            <a class="logo_link" href="#logoLink">
              <img class="logo_image"  src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/site-logo.png" alt="" />
            </a>
          </div>
        </div>
...
<!-- Banner UI 1 -->
<div class="banner-section mt_0 bg-secondary min_h_550 text-white">
  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/shrikant_yadav_full.jpg" class="op1 overlay_w" />
  <div class="container">
      <div class="row">
          <div class="col-12">
              <div class="banner-card nobefore">
                  <p class="pre-banner-heading f14 mb_10 font_montserrat text-uppercase font_bold">Welcome to getwebcodes.in</p>
                  <h1 class="banner-heading f30 mb_20">Learn free codes, tutorials, quizzes and interview questions <br />for students, beginners and developers.</h1>
                  <p class="banner-description mb_30">Our website is specially designed to make the code learning easy. We created a step by step process to learn codes.</p>
   ...
   <div class="container">
     <div class="row">
       <div class="col-12">
         ...
         <p class="text-center mb_40">You can learn <strong>Web Design</strong>, <strong>React JS</strong>, <strong>Angular</strong> and <strong>PHP Programming</strong> on our getWebCodes.in</p>
...
<!-- Video Tutorials in Hindi  Section End -->
 ...
 <!-- Facts  -->
 <section id="myfacts" class="text-white pt_60 pb_20 hide">
   <div class="container">
    <!-- Row Start -->
    <div class="row">
      <div class="col-12 col-sm-6 col-md-3">
        <div class="card cui1c">
          <div class="card-body">
            <div class="ciconc bg-primary">
              <i class="fa fa-thumbs-up" aria-hidden="true"></i>
            </div>
            <h5 class="card-title mbi_0">150+</h5>
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <div class="card cui1c">
          <div class="card-body">
            ...
            <h5 class="card-title mbi_0">7+</h5>
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <div class="card cui1c">
          <div class="card-body">
            ...
            <h5 class="card-title mbi_0">200+</h5>
      ...
      <div class="col-12 col-sm-6 col-md-3">
        <div class="card cui1c">
          <div class="card-body">
            ...
            <h5 class="card-title mbi_0">20000+</h5>
 ...
 <!-- Facts  End -->
 	...
 	<section id="news-and-events" class="common-section-ui">
 		<div class="container">
       <div class="row">
  ...
  <!-- CTA Section End -->
 	...
 	<footer class="section-footer footer_style1 f14">
 		<div class="footer_top pt_60 pb_20">
	 		<div class="container">
              ...
              <h3 class="text-primary f16 lh18 mb_20 text-uppercase text_bold">Get in touch</h3>
	               	...
	               	<div class="col-6 col-md-3">
	                    <h3 class="text-primary f16 lh18 mb_20 text-uppercase text_bold">Popular Links</h3>
                        <ul class="menu">
	                ...
	                <div class="col-6 col-md-3">
	                    <h3 class="text-primary f16 lh18 mb_20 text-uppercase text_bold">Usefull Links</h3>
                        <ul class="menu">
	                ...
	                <div class="col-6 col-md-3">
	                    <h3 class="text-primary f16 lh18 mb_20 text-uppercase text_bold">Social Links</h3>
                      <ul class="socialicons f14 colored siconsc withtext"> 
                        <li class="facebook"><a href="#" title="Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a> Facebook</li>
                        <li class="twitter"><a href="#" title="Twitter" target="_blank"><i class="fab fa-twitter"></i></a> Twitter</li>
                        <li class="instagram"><a href="#" title="Instagram" target="_blank"><i class="fab fa-instagram"></i></a> Instagram</li>
                        <li class="youtube"><a href="#" title="Youtube" target="_blank"><i class="fab fa-youtube"></i></a> Youtube</li>
                      </ul>
	                </div>
	 			</div>
	 		</div>
 		...
 		<div class="footer_bottom bg-secondary text-white pt_20 pb_10">
	 		<div class="container">
	 			<div class="row">
	 				 <div class="col">
	 				 	<p class="f12 lh18 mb_10">&copy; 2020 GetWebCodes.in | All Rights Reserved.</p>
	 				 </div>
	 				 <div class="col">
  ...
  <!-- Popper JS -->
	<script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/popper.min.js" type="text/javascript"></script>
